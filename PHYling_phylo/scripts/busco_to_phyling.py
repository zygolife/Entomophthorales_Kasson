...
for spdir in dirsToRun:
    ...
    idxfile = os.path.join(args.temp, "{}.fasta.idx".format(spdir))
    print(f"making idxfile 1st time for {idxfile} {genome_file}")
